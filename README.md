...
- **UI** – Optimized for modern desktop browsers; mobile layout may need additional work for production use (Currently devices greater than 524 px width are optimized properly).
